...
import com.fasterxml.jackson.module.scala.{ClassTagExtensions, OptionModule, TupleModule}
...
*/
  ...
  /**
    ...
    * @return the object
    */
  def fromJson[T](json: String)(using t: TypeReference[T]): T = mapper.readValue[T](json,t)
